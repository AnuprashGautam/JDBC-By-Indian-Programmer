...
public class ImageInsertionInDatabase {
    public static void main(String[] args) {
        ...
        try {
            ...
            FileInputStream fis=new FileInputStream(image_path);        // To establish the connection.
            byte[] imagedata=new byte[fis.available()];                 // To hold the data.
            fis.read(imagedata);                                        // Reading the data from the path located image file.
